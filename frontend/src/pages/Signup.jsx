  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="w-full max-w-md rounded-panel glass p-6">
        ...
        <p className="text-slate-300 text-sm mt-2">Signup as member. Admin role set in MongoDB.</p>
        ...
        <div className="text-sm text-slate-300 mt-4">
          Already have account? <Link className="text-pink-300 hover:text-pink-200" to="/login">Login</Link>
        </div>
      </div>
    </div>
  );
